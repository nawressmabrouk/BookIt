...
import static com.nawres.book.BookSpecification.*;
...
import com.nawres.common.PageResponse;
import com.nawres.exception.OperationNotPermittedException;
import com.nawres.file.FileStorageService;
import com.nawres.history.BookTransactionHistory;
import com.nawres.history.BookTransactionHistoryRepository;
...
public class BookService {
        ...
        public void uploadBookCoverPicture(MultipartFile file,
                        org.springframework.security.core.Authentication connectedUser, Integer bookId) {
                Book book = bookRepository.findById(bookId)
                                .orElseThrow(() -> new EntityNotFoundException("No book found with ID:: " + bookId));
                User user = ((User) connectedUser.getPrincipal());
